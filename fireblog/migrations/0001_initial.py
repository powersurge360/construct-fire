...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entry'
        db.create_table('fireblog_entry', (
            ...
            ('published', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('fireblog', ['Entry'])


    def backwards(self, orm):
        # Deleting model 'Entry'
        db.delete_table('fireblog_entry')
    ...
    models = {
        ...
        'fireblog.entry': {
            ...
            'published': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        }
    }

    complete_apps = ['fireblog']